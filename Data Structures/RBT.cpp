...
int main(){
	...
	int query[] = {20, 100, 200, 150, 170, 300, 10, 15, 16, 9, 250, 120, 140, 145, 155, 160, 157, 165};
    int delete_query[] = {155, 150, 145, 20, 170, 100, 120, 9, 15, 140};
	for(int i = 0; i < 18; i++) {
		red_black_insert(query[i]);
	...
	for(int i = 0; i < 10; i++) {
		red_black_delete(tree_search(delete_query[i]));
	}

	printf("### Deleted TREE PRINT ###\n");
	tree_print(ROOT);
	printf("\n");
